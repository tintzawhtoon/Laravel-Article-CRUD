        ...
        <div class="w-full  mt-6 px-6 py-4 bg-white shadow-md overflow-hidden rounded-lg">
            <form action="{{ url("/articles/edit/$article->id") }}" method="post">
                ...
                <div class="my-2">
                    ...
                    <input type="text" id="title" name="title" class="bg-gray-100 hover:ring-indigo-500 w-full border-gray-300 rounded-md" value="{{ $article->title }}">
                </div>
                <div class="my-2">
                    <label for="body" class="mb-1">Body</label>
                    <textarea name="body" id="body" rows="5" class="bg-gray-100 hover:ring-indigo-500 w-full border-gray-300 rounded-md">{{$article->body}}</textarea>
                </div>
                <div class="my-2">
